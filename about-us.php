...
<!-- Page Title -->
<title>Helping Hearts Trust - about us</title>
          ...
          <div class="col-md-8">
            <div class="widget no-border m-0">
              <ul class="list-inline pull-right flip sm-pull-none sm-text-center mt-5">
                ...
                <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-white"></i> <a class="text-white" href="#">contact@helpingheartstrust.in</a> </li>
              </ul>
            </div>
          </div>
          <div class="col-md-2">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="media-body bg-silver-light border-1px p-15 mb-20">                     
                      <p>Our mission is providing the basic computer education and other skills to poor, differently abled and non-parental students</p>
                    </div>
                </div>
                <h3 class="line-bottom mt-0">Our Vision</h3>
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="media-body bg-silver-light border-1px p-15 mb-20">
                      <p>Our vision is to develop the skills and knowledge of poor children and women.  And also bring awareness to them about the importance of education.  </p>
                    </div>
                  </div>
              </div>
            </div>
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <h2 class="text-uppercase line-bottom-center mt-0"><span class="text-theme-colored font-weight-600">Award</span></h2>
            ...
            <div class="col-md-12">
              ...
              <div class="gallery-isotope grid-4 gutter-small clearfix" data-lightbox="gallery">
                ...
                <div class="gallery-item ">
                  <div class="thumb" style="padding:6px;">
                    <img alt="project" src="images/gallery/award-1.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="images/gallery/award-1.jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item p-2">
                  <div class="thumb" style="padding:6px;">
                    <img alt="project" src="images/gallery/award-2.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="images/gallery/award-2.jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item p-2">
                  <div class="thumb" style="padding:6px;">
                    <img alt="project" src="images/gallery/award-3.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="images/gallery/award-3.jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item p-2">
                  <div class="thumb" style="padding:6px;">
                    <img alt="project" src="images/gallery/award-4.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="images/gallery/award-4.jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-12">
              ...
              <h2 class="text-white">Just call at <span class="text-theme-colored">(04171) 225450</span> to make a donation</h2>
            </div>
          </div>
        </div>
      </div>      
          ...
          <div class="owl-carousel-3col">
            <div class="item">
              <div class="causes bg-white maxwidth500 mb-30">
                ...
                <a href="ajax-load/donation-form.php" class="btn btn-default btn-theme-colored btn-xs font-16 mt-10 ajaxload-popup">Donate <i class="flaticon-charity-make-a-donation font-16 ml-5"></i></a>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="causes bg-white maxwidth500 mb-30">
                ...
                <h4 class="text-uppercase"><a href="">Sponsor a child today</a></h4>
                  <div class="progress-item mt-0">
                    <div class="progress mb-0">
                      <div data-percent="84" class="progress-bar"><span class="percent">0</span></div>
                    </div>
            ...
            <div class="item">
              <div class="causes bg-white maxwidth500 mb-30">
                ...
                <h4 class="text-uppercase"><a href="">Shelter for Poor Child</a></h4>
                  <div class="progress-item mt-0">
                    <div class="progress mb-0">
                      <div data-percent="84" class="progress-bar"><span class="percent">0</span></div>
                    </div>
            ...
            <div class="item">
              <div class="causes bg-white maxwidth500 mb-30">
                ...
                <h4 class="text-uppercase"><a href="">Happiness for orphan child</a></h4>
                  <div class="progress-item mt-0">
                    <div class="progress mb-0">
                      <div data-percent="84" class="progress-bar"><span class="percent">0</span></div>
                    </div>
