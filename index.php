...
<meta name="description" content="Helping Heart Trust" />
<meta name="keywords" content="Helping Heart Trust" />
<meta name="author" content="Helping Heart Trust" />

<!-- Page Title -->
<title>Helping Heart Trust</title>
...
<div id="wrapper" class="clearfix">
          ...
          <div class="col-md-2">
            <div class="widget no-border m-0">
              <ul class="styled-icons icon-dark icon-theme-colored icon-sm sm-text-center">
                <li><a
                    href="https://www.facebook.com/pages/category/Non-Governmental-Organization--NGO-/Helping-Hearts-Trust-1728938384085674/"
                    target="_blank"><i class="fa fa-facebook"></i></a></li>
                <li><a href="https://www.instagram.com/helpingheartstrust_ngo/?hl=en" target="_blank"><i
                      class="fa fa-twitter"></i></a></li>
                <li><a href="https://www.instagram.com/helpingheartstrust_ngo/?hl=en" target="_blank"><i
                      class="fa fa-instagram"></i></a></li>
                <li><a href="https://www.youtube.com/channel/UC_ZInnuDkoJYUMdm2rpWnFw" target="_blank"><i
            ...
            <div class="widget no-border m-0">
              <ul class="list-inline pull-right flip sm-pull-none sm-text-center mt-5">
                <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-white"></i> <a class="text-white"
                    href="#">96008 35450 </a> </li>
                <li class="text-white m-0 pl-10 pr-10"> <i class="fa fa-clock-o text-white"></i> Mon-Sat 9:00 to 6:30
                </li>
                <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-white"></i> <a class="text-white"
                    href="#">contact@helpingheartstrust.in</a> </li>
              </ul>
            </div>
          </div>
          <div class="col-md-2">
            <div class="widget no-border m-0">
              <ul class="list-inline pull-right flip sm-pull-none sm-text-center mt-5">
                <li class="mt-sm-10 mb-sm-10">
                  ...
                  <a class="btn btn-default btn-flat btn-xs bg-light p-5 font-11 pl-10 pr-10 ajaxload-popup"
                    href="ajax-load/donation-form.php">Donate Now</a>
                </li>
                <li class="mt-sm-10 mb-sm-10">
                  <a class="btn btn-default btn-flat btn-xs bg-light p-5 font-11 pl-10 pr-10 ajaxload-popup"
                    href="ajax-load/volunteer-apply-form.php">Join Us</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div class="main-content">
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider rev_slider_default" data-version="5.0">
            <ul>
              ...
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg23.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                <!-- MAIN IMAGE -->
              ...
              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg20.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2" data-description="">
                <!-- MAIN IMAGE -->
              ...
              <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg24.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/bg24.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
              </li>
                 ...
                 <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/bg/bg24.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/bg/bg22.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
              </li>
            </ul>
          </div>
    ...
    <section class="divider bg-theme-colored" data-parallax-ratio="0.7">
      <div class="container pt-30 pb-30">
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-white text-uppercase mt-0">Join With Us to Change The World</h2>
              <h3 class="text-white mt-5">Just call at <span class="text-white">(+91) 96008 35450</span> to make a
                donation</h3>
            </div>
          </div>
        </div>
        ...
        <div class="section-content">
          <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
              <div class="icon-box text-center p-0 mt-sm-30 mb-sm-40 p-40 border-1px border-theme-colored" data-bg-img="images/about/f1.jpg" style="background-image: url(&quot;images/about/f1.jpg&quot;);">
                <a href="#" class="icon">
                  <i class="flaticon-charity-shaking-hands-inside-a-heart font-54 text-theme-colored"></i>
                </a>
                <div>
                  <h3 class="icon-box-title text-theme-colored mt-10 mb-10 text-uppercase">Become a Volunteer</h3>
                  <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum diam tortor, egestas varius erat aliquam a. </p>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6 mt-20">
              <div class="row">
                <div class="col-md-6 col-sm-6 pl-0 pr-0 p-2">
                  <div class="img-hover-border mt-sm-30">
                    <img class="img-fullwidth" src="images/about/about-3.jpg" alt="">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6 pl-2">
                  <div class="img-hover-border mt-sm-40">
                    <img class="img-fullwidth" src="images/about/about-1.png" alt="">
                  </div>
                  <div class="img-hover-border mt-sm-30 mt-5">
                    <img class="img-fullwidth" src="images/about/about-2.png" alt="">
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <div class="about-details">
                <h2 class="font-36 mt-0"> Welcome to <span class="text-theme-colored">Helping Hearts Trust</span>
                  Please Rise your Helping Hand</h2>
                <p class="text-justify">Helping Hearts Trust is a Non-Governmental Organisation (Reg no: 04/IV/2017
                  )which is actively working to develop the life of non parental children, differently abled children
                  and poor children in many villages by improving the knowledge and their skills. Our Trust is mainly
                  focused in developing the computer and English knowledge to those children which helps them to
                  sustain in the competitive world.</p>
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <h2 class="text-uppercase line-bottom-center mt-0">Our <span
              class="text-theme-colored font-weight-600">Causes</span></h2>
        ...
        <div class="item">
          <div class="causes bg-white maxwidth500 mb-30">
            ...
            <div class="causes-details clearfix border-bottom p-15 pt-15 pb-15">
              ...
              <a href="ajax-load/donation-form.php"
                class="btn btn-default btn-theme-colored btn-xs font-16 mt-10 ajaxload-popup"><i
                  class="flaticon-charity-make-a-donation font-16 ml-5"></i> Donate <i
        ...
        <div class="item">
          <div class="causes bg-white maxwidth500 mb-30">
            ...
            <div class="causes-details clearfix border-bottom p-15 pt-15 pb-15">
              ...
              <h4 class="text-uppercase"><a href="page-single-cause.php">Sponsor a child today</a></h4>
              <div class="progress-item mt-0">
                <div class="progress mb-0">
                  <div data-percent="84" class="progress-bar"><span class="percent">0</span></div>
                </div>
        ...
        <div class="item">
          <div class="causes bg-white maxwidth500 mb-30">
            ...
            <div class="causes-details clearfix border-bottom p-15 pt-15 pb-15">
              ...
              <h4 class="text-uppercase"><a href="page-single-cause.php">Shelter for Poor Child</a></h4>
              <div class="progress-item mt-0">
                <div class="progress mb-0">
                  <div data-percent="84" class="progress-bar"><span class="percent">0</span></div>
                </div>
        ...
        <div class="item">
          <div class="causes bg-white maxwidth500 mb-30">
            ...
            <div class="causes-details clearfix border-bottom p-15 pt-15 pb-15">
              ...
              <h4 class="text-uppercase"><a href="page-single-cause.php">Happiness for orphan child</a></h4>
              <div class="progress-item mt-0">
                <div class="progress mb-0">
                  <div data-percent="84" class="progress-bar"><span class="percent">0</span></div>
                </div>
 ...
 <!-- Divider: Funfact -->
 <section class="divider parallax layer-overlay overlay-dark-9" data-bg-img="images/bg/bg4.jpg"
   ...
   <div class="row">
     <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
       <div class="funfact text-center">
         ...
         <h2 data-animation-duration="2000" data-value="1054"
     ...
     <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
       <div class="funfact text-center">
         ...
         <h2 data-animation-duration="2000" data-value="875"
           class="animate-number text-white font-42 font-weight-500 mt-0 mb-0">0</h2>
     ...
     <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
       <div class="funfact text-center">
         ...
         <h2 data-animation-duration="2000" data-value="54"
           class="animate-number text-white font-42 font-weight-500 mt-0 mb-0">0</h2>
        ...
        <div class="col-md-8 pb-sm-20">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="media-body bg-silver-light border-1px p-15 mb-20">
                <p>Our mission is providing the basic computer education and other skills to poor, differently
                  abled and non-parental students</p>
              </div>
            </div>
            <h3 class="line-bottom mt-0">Our Vision</h3>
            <div class="col-xs-12 col-sm-12 col-md-12">
              <div class="media-body bg-silver-light border-1px p-15 mb-20">
                <p>Our vision is to develop the skills and knowledge of poor children and women. And also bring
                  awareness to them about the importance of education. </p>
              </div>
            </div>
          </div>
        </div>
...
<section id="services" class="bg-silver-light">
  <div class="container">
    <div class="section-title text-center">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <h2 class="text-uppercase mt-0 line-height-1">What We Are Doing?</h2>
          <div class="title-icon">
            <i class="flaticon-charity-hand-holding-a-heart"></i>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
          <div class="text-center box-shadow11 mb-30 bg-white p-30">
            <a href="#" class="">
              <img src="images/flaticon-png/small/4.png" width="70" alt="">
            </a>
            <h4 class="font-weight-600 mt-20">Skill Development Training</h4>
            <p>Skill development training enhances individuals' capabilities,fostering personal and professional
              growth</p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
          <div class="text-center box-shadow11 mb-30 bg-white p-30">
            <a href="#" class="">
              <img src="images/flaticon-png/small/7.png" width="70" alt="">
            </a>
            <h4 class="font-weight-600 mt-20">Educational Awareness & Supporting</h4>
            <p>Education has been a key focus area of our Helping Hearts Trust.</p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
          <div class="text-center box-shadow11 mb-30 bg-white p-30">
            ...
            <h4 class="font-weight-600 mt-20">Health & Nutriction Awareness Programs</h4>
            <p>Promote well-being through Health & Nutrition Awareness Programs.</p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
          <div class="text-center box-shadow11 mb-30 bg-white p-30">
            <a href="#" class="">
              <img src="images/flaticon-png/small/2.png" width="70" alt="">
            </a>
            <h4 class="font-weight-600 mt-20">Women's & Child Development </h4>
            <p>Women's & Child Development focuses on enhancing the well-being of women and children</p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
          <div class="text-center box-shadow11 mb-sm-30 bg-white p-30">
            ...
            <h4 class="font-weight-600 mt-20">Mobilisation Social Work</h4>
            <p>Social work mobilization involves activating and engaging communities to address social issues</p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
          <div class="text-center box-shadow11 mb-sm-30 bg-white p-30">
            <a href="#" class="">
              <img src="images/flaticon-png/small/5.png" width="70" alt="">
            </a>
            <h4 class="font-weight-600 mt-20">Environment & Green Revolution</h4>
            <p>Nature is the mother of all human beings and animals.</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="divider parallax layer-overlay overlay-dark-9" data-bg-img="images/bg/bg23.jpg"
  data-parallax-ratio="0.7">
          ...
          <div class="testimonial style1 owl-carousel-2col">
            <div class="item">
              <div class="comment border-radius-15px">
                <p>Next generation having great person Founder continue to your work sir we support u forever</p>
              </div>
              <div class="content mt-20">
                <div class="thumb pull-right">
                  <img class="img-circle" alt="" src="images/testimonials/s1.png">
                </div>
                <div class="patient-details text-right pull-right mr-20 mt-10">
                  <h5 class="text-theme-colored">Devadharshini Mohan</h5>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="comment border-radius-15px">
                <p>Great place to service , and Great Person Rajesh alais Parthiban Sir</p>
              </div>
              <div class="content mt-20">
                <div class="thumb pull-right">
                  <img class="img-circle" alt="" src="images/testimonials/s1.png">
                ...
                <div class="patient-details text-right pull-right mr-20 mt-10">
                  <h5 class="text-theme-colored">Sridhar J</h5>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="comment border-radius-15px">
                <p>Really Happy to Spent time to this ngo , i m thanks to Parthiban Sir,</p>
              </div>
              <div class="content mt-20">
                <div class="thumb pull-right">
                  <img class="img-circle" alt="" src="images/testimonials/s1.png">
                ...
                <div class="patient-details text-right pull-right mr-20 mt-10">
                  <h5 class="text-theme-colored">raghul B</h5>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="gallery-isotope grid-4 gutter-small clearfix" data-lightbox="gallery">
            ...
            <div class="gallery-item">
              <div class="thumb">
                <img alt="project" src="images/gallery/13.jpg" class="img-fullwidth">
                <div class="overlay-shade"></div>
                <div class="icons-holder">
                  <div class="icons-holder-inner">
                    <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                      <a href="images/gallery/13.jpg" data-lightbox-gallery="gallery"><i
                          class="fa fa-picture-o"></i></a>
                    </div>
                  </div>
                </div>
        ...
        <div class="row border-bottom-black">
          <div class="col-sm-6 col-md-4">
            <div class="widget dark">
              ...
              <ul class="mt-5">
                <li class="m-0 pl-0 pr-10 text-black"> <i class="fa fa-phone text-theme-colored mr-5"></i> <a
                    class="text-white" href="#">+91 9600835450</a> </li>
                <li class="m-0 pl-0 pr-10 text-black"> <i class="fa fa-envelope-o text-theme-colored mr-5"></i> <a
                    class="text-white" href="#">contact@helpingheartstrust.in</a> </li>
                <li class="m-0 pl-0 pr-10 text-black"> <i class="fa fa-globe text-theme-colored mr-5"></i> <a
                    class="text-white" href="www.helpingheartstrust.in">www.helpingheartstrust.in</a> </li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
        ...
        <div class="container pt-20 pb-20">
          <div class="row">
            <div class="col-md-6 sm-text-center">
              <p class="font-13 text-white m-0">Copyright &copy;
                <script>document.write(new Date().getFullYear())</script> Helping Hearts Trust. All Rights Reserved
              </p>
            </div>
